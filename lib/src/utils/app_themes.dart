...
class AppThemes {
  ...
  static Color borderColor(BuildContext context) => Theme.of(context).colorScheme.secondary.withValues(alpha: .2);

  /// Standard translucent border style used across glassmorphic cards and buttons.
  static Border border(BuildContext context) => Border.all(color: borderColor(context));
}
